...
public abstract class ILogitech extends com.logitech.gaming.LogiLED implements IPerifericos.IPerifericos {
    ...
    protected final int[][] teclas = {
        {0xFFFF1, 0x01, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f, 0x40, 0x41, 0x42, 0x43, 0x44, 0x57, 0x58, 0x137, 0x46, 0x145},
        ...
        {0xFFF5, 0x1D, 0x15B, 0x38, 0x39, 0x138, 0x15C, 0x15D, 0x11D, 0x14B, 0x150, 0x14D, 0x52}
    };
    ...
    public void colorirDispositivo() {
        LogiLedInit();
        ColorLogitech corLocal = this.getCor();
        try {
            for (int i : zonasRGB) {
                LogiLedSetLightingForTargetZone(tipoDoDispositivo, i, corLocal.getR(), corLocal.getG(), corLocal.getB());
            }
