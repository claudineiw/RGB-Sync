...
import com.msi.sdk.MsiColor;
import com.msi.sdk.LedInfo;
...
public final class LED {
    ...
    protected LED(@NonNull final Device device, final int index) {
        ...
        this.device = device;
        this.index = index;
        this.ledInfo = MsiSDK.getLedInfo(device.getIdentifier(), index);
    }
     ...
     */
    public MsiColor getColor() {
        return MsiSDK.getLedColor(device.getIdentifier(), index);
    }
    ...
    public String getStyle() {
        return MsiSDK.getLedStyle(device.getIdentifier(), index);
    }
    ...
    public int getMaximumBrightnessLevel() {
        return MsiSDK.getLedMaxBright(device.getIdentifier(), index);
    }
    ...
    public int getBrightnessLevel() {
        return MsiSDK.getLedBright(device.getIdentifier(), index);
    }
    ...
    public int getMaximumSpeedLevel() {
        return MsiSDK.getLedMaxSpeed(device.getIdentifier(), index);
    }
    ...
    public int getSpeedLevel() {
        return MsiSDK.getLedSpeed(device.getIdentifier(), index);
    }
     ...
     */
    public void setColor(@NonNull final MsiColor color) {
        MsiSDK.setLedColor(device.getIdentifier(), index, color);
    }
    ...
    public void setColor(final int red, final int green, final int blue) {
        setColor(new MsiColor((short) red, (short) green, (short) blue));
    }
    ...
    public void setStyle(@NonNull final String style) {
        ...
        MsiSDK.setLedStyle(device.getIdentifier(), index, style);
    }
    ...
    public void setBrightnessLevel(final int brightnessLevel) {
        ...
        MsiSDK.setLedBright(device.getIdentifier(), index, brightnessLevel);
    }
    ...
    public void setSpeedLevel(final int speedLevel) {
        ...
        MsiSDK.setLedSpeed(device.getIdentifier(), index, speedLevel);
    }
}
