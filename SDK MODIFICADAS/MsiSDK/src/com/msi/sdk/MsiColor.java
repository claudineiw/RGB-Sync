...
@EqualsAndHashCode
@ToString
public final class MsiColor {
    private final short red;
    private final short green;
    private final short blue;

    public MsiColor(final short red, final short green, final short blue) {
     ...
     */
    public static MsiColor of(final int red, final int green, final int blue) {
        return new MsiColor((short) red, (short) green, (short) blue);
    }
}
