...
public class AuraRGBLight
{
    ...
    public AuraRGBLight(AuraSDKDevice parent, IAuraRgbLight rawLight)
    {
        ...
        this.$parent = parent;
        name = rawLight.name();
        color = new AsusColor(rawLight.red(), rawLight.green(), rawLight.blue());
    }
     ...
     */
    public void setColor(AsusColor color)
    {
        setColor(color, true);
    }
     ...
     */
    public void setColor(AsusColor color, boolean apply)
    {
     ...
     */
    public AsusColor getColor()
    {
        return new AsusColor(rawLight.color());
    }
}
