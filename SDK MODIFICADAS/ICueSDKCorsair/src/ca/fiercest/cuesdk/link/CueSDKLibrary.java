...
public interface CueSDKLibrary extends Library
{
	...
	interface CorsairEventHandler extends Callback
	{
		...
		void apply(Pointer context, LinkCorsairEvent event);
	}
	...
	LinkCorsairDeviceInfo CorsairGetDeviceInfo(int deviceIndex);

	//@return JNACorsairLedPositions
	LinkCorsairLedPositions.ByReference CorsairGetLedPositions();

	//Lighting

	//@param ledsColors CorsairLedColor[]
	boolean CorsairSetLedsColors(int size, LinkCorsairLedColor ledsColors);

	boolean CorsairGetLedsColors(int size, LinkCorsairLedColor ledsColors);
	...
	LinkCorsairProtocolDetails.ByValue CorsairPerformProtocolHandshake();
